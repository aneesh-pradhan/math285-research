...
Electric circuits are fundamental to modern technology, powering everything
from household appliances to advanced communication systems~\cite{nilsson2019}.
Among the most studied configurations is the series RLC circuit, which
connects a resistor, an inductor, and a capacitor in series with a voltage
source.
This topology appears throughout electrical engineering in the design of
bandpass filters, resonant oscillators, and impedance-matching networks.
